...
model_paths = {
    'swin_v2_b': '/root/autodl-nas/swinv2_base_patch4_window12_192_22k.pth',
}
...
class Swin_V2_B_Weights(WeightsEnum):
    ...
    IMAGENET22K = Weights(
        url="/root/autodl-nas/swinv2_base_patch4_window12_192_22k.pth",
        transforms=partial(
            ImageClassification, crop_size=384, resize_size=388, interpolation=InterpolationMode.BICUBIC
        ),
        meta={
            **_COMMON_META,
            "num_params": 28351570,
...
def swin_v2_b(*, weights: Optional[Swin_V2_B_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    ...
    state_dict = torch.load(model_paths['swin_v2_b'])
    print(state_dict)
